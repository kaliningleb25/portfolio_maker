package com.kaliningleb25.portfolio_maker.config;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configureGlobal(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.inMemoryAuthentication()
                .withUser("user").password("{noop}password").roles("USER") // TODO: remove noop
                .and()
                .withUser("admin").password("{noop}password").roles("ADMIN");  // TODO: remove noop
    }
}
